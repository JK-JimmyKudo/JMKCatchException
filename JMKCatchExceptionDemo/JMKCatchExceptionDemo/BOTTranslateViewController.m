...
@interface BOTTranslateViewController ()<UITableViewDelegate,UITableViewDataSource>
@property(strong,nonatomic)NSMutableArray<JMKExceptionBox*> *dataSource;
@property(strong,nonatomic)UITableView                     *tableview;
@property(strong,nonatomic)UILabel                         *reasonLab;

@end

@implementation BOTTranslateViewController
...
- (void)clickRight{
    ...
    [[JMKCatchExceptionTool shareInstance]clearAllLog];
}


- (void)loadData{
    JMKCatchExceptionTool *tool = [JMKCatchExceptionTool shareInstance];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[JMKCatchExceptionTool shareInstance] removeExceptionItemIndex:indexPath.row];
}
